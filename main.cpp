...
int main()
{
    ...
    // --------------------
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "0432320005101108", NULL, NULL);
    if (window == NULL)
    {
...
// If R was pressed before → stay red forever
if (forceRed)
{
...
{
    // If W is held triangle becomes white
    ...
    // Press R to make the triangle red permanently
